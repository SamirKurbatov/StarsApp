...
namespace StarsApp
{
    public partial class Form1 : Form
    {
        ...
        private float Map(float n, float firstStart, float firstStop, float secondStart, float secondStop)
        {
            return((n - firstStart) / (firstStop - firstStart)) * (secondStop - secondStart) + secondStart;
        }
